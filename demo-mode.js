...
window.DEMO_ACCOUNTS = {
    ...
    // 業者ログイン用
    'pn001-yamada': {companyCode:'PN001',id:'pn001-yamada',password:'demo',name:'山田 太郎',role:'contractor',companyName:'東京設備工業株式会社',partnerId:'PN001',partnerCode:'PN001',categories:['居室・生活','厨房・食事','介護・医療'],assignedCompanies:['TAMJ','JMAT'],status:'active',isDemoMode:true}
};

// ========== 業者マスタ ==========
window.DEMO_PARTNERS = [
    {id:'PN001',name:'東京設備工業株式会社',partnerCode:'PN001',categories:['居室・生活','厨房・食事','介護・医療'],status:'active',contactName:'山田 太郎',contacts:[{name:'山田 太郎',loginId:'pn001-yamada',password:'demo',phone:'090-1234-5678',isMain:true},{name:'高橋 次郎',loginId:'pn001-takahashi',password:'demo',phone:'090-8765-4321',isMain:false}]},
    {id:'PN002',name:'関東水道サービス',partnerCode:'PN002',categories:['建物インフラ'],status:'active',contactName:'佐藤 花子',contacts:[{name:'佐藤 花子',loginId:'p002-sato',password:'demo',phone:'090-1111-2222',isMain:true}]},
    {id:'PN003',name:'日本電気工事',partnerCode:'PN003',categories:['IT・安全'],status:'active',contactName:'鈴木 一郎',contacts:[{name:'鈴木 一郎',loginId:'p003-suzuki',password:'demo',phone:'090-3333-4444',isMain:true}]},
    {id:'PN004',name:'ケアテック東京',partnerCode:'PN004',categories:['介護・医療','居室・生活'],status:'active',contactName:'遠藤 修一',contacts:[{name:'遠藤 修一',loginId:'p004-endo',password:'demo',phone:'090-5555-6666',isMain:true}]},
    {id:'PN005',name:'横浜ビルメンテナンス',partnerCode:'PN005',categories:['建物インフラ','IT・安全'],status:'active',contactName:'川村 拓海',contacts:[{name:'川村 拓海',loginId:'p005-kawamura',password:'demo',phone:'090-7777-8888',isMain:true}]},
    {id:'PN006',name:'メディカルサポート神奈川',partnerCode:'PN006',categories:['介護・医療'],status:'active',contactName:'三浦 陽子',contacts:[{name:'三浦 陽子',loginId:'p006-miura',password:'demo',phone:'090-9999-0000',isMain:true}]}
];
...
function generateDemoReports(companyCode, officeCodes, officeNames, accounts) {
    var reports = [];
    var data = [
        ['2F居室のエアコンが冷えない','建物インフラ','完了'],['共用廊下の蛍光灯が切れている','建物インフラ','完了'],
        ['浴室の排水が詰まり気味','建物インフラ','対応中'],['車いすのブレーキが効きにくい','介護・医療','未対応'],
        ['業務用冷蔵庫から異音','厨房・食事','完了'],['ナースコール応答遅延','IT・安全','対応中'],
        ['玄関の自動ドアの動作が遅い','建物インフラ','完了'],['給湯器のお湯が出にくい','建物インフラ','未対応'],
        ['3F共用スペースのTV映らない','居室・生活','完了'],['歩行器のゴム摩耗','介護・医療','完了'],
        ['食洗機のエラー表示','厨房・食事','対応中'],['Wi-Fiが途切れる','IT・安全','完了'],
        ['電動ベッドのリモコン故障','居室・生活','未対応'],['防犯カメラの映像乱れ','IT・安全','完了'],
        ['スチコンの温度上がらない','厨房・食事','対応中'],['消火器の期限切れ確認','建物インフラ','完了'],
        ['洗濯機の脱水異音','居室・生活','完了'],['吸引器の吸引力低下','介護・医療','未対応'],
        ['AEDバッテリー警告表示','介護・医療','対応中'],['配膳車のキャスター不具合','厨房・食事','完了'],
        ['複合機の紙詰まり頻発','IT・安全','完了'],['分電盤から焦げ臭い','建物インフラ','対応中'],
        ['パルスオキシメーター電池切れ','介護・医療','完了'],['製氷機が氷を作らない','厨房・食事','未対応']
    ];
...
function initDemoData() {
    if (localStorage.getItem('demo_initialized') === 'v3') return;
    ...
    localStorage.setItem('demo_initialized', 'v3');
}
