  ...
  try {
    ...
    await client.query(`
      INSERT INTO partners (id, partner_code, name, contact_name, categories, status) VALUES
        ('PN001', 'PN001', 'TAMJ建設', '山田 太郎', '["建物・外","部屋・共用部","介護医療備品","厨房","ネットワーク","浴室","福祉用具"]', 'active'),
        ('PN002', 'PN002', 'ACタムジ', '青木 一郎', '["建物・外"]', 'active'),
        ('PN003', 'PN003', 'EVタムジ', '江藤 健太', '["建物・外"]', 'active'),
        ('PN004', 'PN004', 'タムタム家具', '田村 美咲', '["部屋・共用部","介護医療備品","厨房","ネットワーク"]', 'active'),
        ('PN005', 'PN005', 'リネンTAMJ', '林 誠', '["部屋・共用部"]', 'active'),
        ('PN006', 'PN006', '福たむ', '福田 裕子', '["部屋・共用部","介護医療備品","厨房","浴室","福祉用具"]', 'active'),
        ('PN007', 'PN007', 'AEDタム', '安藤 大輔', '["介護医療備品"]', 'active'),
        ('PN008', 'PN008', 'お掃除タムタム', '大島 春菜', '["厨房"]', 'active'),
        ('PN009', 'PN009', 'キッチンタムジ', '北村 和也', '["厨房"]', 'active'),
        ('PN010', 'PN010', 'タムネット', '中田 翔', '["ネットワーク"]', 'active'),
        ('PN011', 'PN011', 'タム電気', '堂本 光', '["ネットワーク"]', 'active'),
        ('PN012', 'PN012', 'タムセキュリティ', '関口 武', '["ネットワーク"]', 'active'),
        ('PN013', 'PN013', '介護タム', '加藤 優', '["ネットワーク"]', 'active'),
        ('PN014', 'PN014', 'Nタムタム', '西村 拓', '["ネットワーク"]', 'active'),
        ('PN015', 'PN015', 'タムコール', '小林 恵', '["ネットワーク"]', 'active')
      ON CONFLICT (id) DO NOTHING
    `);
    ...
    await client.query(`
      INSERT INTO contracts (id, partner_id, company_code, categories, status) VALUES
        ('CNT-TAMJ-001', 'PN001', 'TAMJ', '["建物・外","部屋・共用部","介護医療備品","厨房","ネットワーク"]', 'active'),
        ('CNT-TAMJ-002', 'PN002', 'TAMJ', '["建物・外"]', 'active'),
        ('CNT-TAMJ-003', 'PN003', 'TAMJ', '["建物・外"]', 'active'),
        ('CNT-TAMJ-004', 'PN004', 'TAMJ', '["部屋・共用部","介護医療備品","厨房","ネットワーク"]', 'active'),
        ('CNT-TAMJ-005', 'PN005', 'TAMJ', '["部屋・共用部"]', 'active'),
        ('CNT-TAMJ-006', 'PN006', 'TAMJ', '["部屋・共用部","介護医療備品","厨房"]', 'active'),
        ('CNT-TAMJ-007', 'PN007', 'TAMJ', '["介護医療備品"]', 'active'),
        ('CNT-TAMJ-008', 'PN008', 'TAMJ', '["厨房"]', 'active'),
        ('CNT-TAMJ-009', 'PN009', 'TAMJ', '["厨房"]', 'active'),
        ('CNT-TAMJ-010', 'PN010', 'TAMJ', '["ネットワーク"]', 'active'),
        ('CNT-TAMJ-011', 'PN011', 'TAMJ', '["ネットワーク"]', 'active'),
        ('CNT-TAMJ-012', 'PN012', 'TAMJ', '["ネットワーク"]', 'active'),
        ('CNT-TAMJ-013', 'PN013', 'TAMJ', '["ネットワーク"]', 'active'),
        ('CNT-TAMJ-014', 'PN014', 'TAMJ', '["ネットワーク"]', 'active'),
        ('CNT-TAMJ-015', 'PN015', 'TAMJ', '["ネットワーク"]', 'active')
      ON CONFLICT (id) DO NOTHING
    `);
